    ...
    <div>
      ...
      >
        <div className="container-unified">
          <Card className="overflow-hidden" hover={false} style={{ padding: 0, boxShadow: '0 4px 20px rgba(0, 0, 0, 0.08)', borderRadius: '12px', border: '1px solid #E5E5E5', backgroundColor: '#FFFFFF', position: 'relative' }}>
            ...
            <div style={{ padding: 'clamp(27px, 3.4vw, 41px)', position: 'relative', zIndex: 2 }}>
              <Tabs
                defaultTab="overview"
                tabs={[
                  { id: 'overview', label: 'Overview', content: <p style={{ fontFamily: 'var(--font-inter), Inter, sans-serif', fontSize: 'clamp(18px, 2vw, 19px)', lineHeight: 1.8, color: '#000000', fontWeight: 600 }}>{division.overview}</p> },
                  { id: 'establishment', label: 'Establishment', content: <p style={{ fontFamily: 'var(--font-inter), Inter, sans-serif', fontSize: 'clamp(18px, 2vw, 19px)', lineHeight: 1.8, color: '#000000', fontWeight: 600 }}>{division.establishment}</p> },
                  ...
                  { id: 'ceo-message', label: 'Founder\'s Message', content: (
                    <div style={{ padding: 'clamp(27px, 3.4vw, 34px)', background: 'rgba(240, 253, 255, 0.35)', backdropFilter: 'blur(12px)', borderRadius: '8px', borderLeft: '4px solid #01B2B2', border: '1px solid rgba(229, 229, 229, 0.3)' }}>
                      <p style={{ fontFamily: 'var(--font-inter), Inter, sans-serif', fontSize: 'clamp(20px, 2.2vw, 21px)', fontWeight: 700, color: '#000000', marginBottom: 'clamp(8px, 1vw, 12px)' }}>{division.ceoMessage.name}</p>
                      <p style={{ fontFamily: 'var(--font-inter), Inter, sans-serif', fontSize: 'clamp(18px, 2vw, 19px)', color: '#000000', fontWeight: 600, marginBottom: 'clamp(20px, 2.5vw, 24px)' }}>{division.ceoMessage.title}</p>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'clamp(20px, 2.6vw, 27px)' }}>
                          {division.cooQuotes.map((coo, idx) => (
                            <motion.div
                              ...
                              style={{ padding: 'clamp(20px, 2.6vw, 27px)', backgroundColor: 'rgba(255, 255, 255, 0.35)', backdropFilter: 'blur(12px)', borderRadius: '8px', border: '1px solid rgba(229, 229, 229, 0.3)', borderLeft: '4px solid #D4AF37', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)', transition: 'all 0.3s ease' }}
                              onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 4px 12px rgba(0, 0, 0, 0.08)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
                              onMouseLeave={(e) => { e.currentTarget.style.boxShadow = '0 2px 8px rgba(0, 0, 0, 0.04)'; e.currentTarget.style.transform = 'translateY(0)'; }}
                            >
                              <p style={{ fontFamily: 'var(--font-inter), Inter, sans-serif', fontSize: 'clamp(15px, 1.7vw, 16px)', fontWeight: 700, color: '#000000', marginBottom: 'clamp(7px, 0.9vw, 10px)' }}>{coo.name}</p>
                              <p style={{ fontFamily: 'var(--font-inter), Inter, sans-serif', fontSize: 'clamp(14px, 1.5vw, 15px)', color: '#000000', fontWeight: 600, marginBottom: 'clamp(14px, 1.7vw, 17px)' }}>{coo.title}</p>
                              <p style={{ fontFamily: 'var(--font-inter), Inter, sans-serif', fontSize: 'clamp(14px, 1.6vw, 16px)', lineHeight: 1.7, color: '#000000', fontWeight: 600, fontStyle: 'italic' }}>"{coo.quote}"</p>
                            </motion.div>
                          ))}
                        </div>
                      </div>
                  ...
                  }] : []),
                  {
                    id: 'album',
                    label: 'Album',
                    content: <AlbumGallery divisionId="jewelust" />
                  }
                ]}
              />
            </div>
